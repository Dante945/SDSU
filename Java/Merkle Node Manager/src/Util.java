...
public class Util {
    ...
    public String getMerkleRoot(ArrayList<String> merkleWords) {      //note variable name.

        // *** Creating MerkleNode Objects. ***
        ...
        oNode1.sHash = generateHash(merkleWords.get(0));
        oNode2.sHash = generateHash(merkleWords.get(1));
        oNode3.sHash = generateHash(merkleWords.get(2));
        oNode4.sHash = generateHash(merkleWords.get(3));
